...
if("cuda" IN_LIST FEATURES)
    ...
    # cuDSS: Look relative to this port's overlay directory
    set(CUDSS_BASE_DIR "${CMAKE_CURRENT_LIST_DIR}/../../cuDSS")
    if(EXISTS "${CUDSS_BASE_DIR}/lib/13/cmake/cudss")
        list(APPEND FEATURE_OPTIONS
            "-Dcudss_DIR=${CUDSS_BASE_DIR}/lib/13/cmake/cudss"
        )
        message(STATUS "cuDSS found at ${CUDSS_BASE_DIR}")
    else()
        message(WARNING "cuDSS not found at ${CUDSS_BASE_DIR} — GPU solver may fall back to CPU")
    endif()
endif()
